...
const UpdateProjectPage = ({ id }) => {
    ...
    return `
        ...
        <input type="text"  value="${project.title}" id="title"/>
        <input type="text" value="${project.description}" id="description"/>
        <input type="img" value="${project.image}" id="image"/>
        <input type="text" value="${project.url}" id="url"/>
        <input type="text" value="${project.repository}" id="repository"/>
